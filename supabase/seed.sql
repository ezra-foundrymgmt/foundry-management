insert into public.organizations(id,name,slug,settings_json) values ('00000000-0000-4000-8000-000000000001','Foundry Management','foundry','{"demo_mode":true,"content_buffer":{"target":14,"warning":10,"critical":7}}') on conflict do nothing;
...
values ('10000000-0000-4000-8000-000000000001','00000000-0000-4000-8000-000000000001','PR-000001','Jessica','Jessica Hart','Fitness & lifestyle',184000,87,'PRIORITY','SIGNED','DEMO_SEED') on conflict do nothing;
...
('20000000-0000-4000-8000-000000000003','00000000-0000-4000-8000-000000000001','CR-000003','Sarah','Sarah Vale','sarah@fictional.demo','US','America/Chicago','2026-05-12','WATCH','SIGNED','PASSED','PASSED','AT_RISK',58,5,'Instagram') on conflict do nothing;
...
from generate_series('2026-08-06'::date,'2026-09-01'::date,'1 day') d on conflict do nothing;
insert into public.creator_revenue_daily(organization_id,creator_id,date,platform,creator_platform_receipts,new_subscribers,first_buyers,paying_fans,source,data_confidence)
values ('00000000-0000-4000-8000-000000000001','20000000-0000-4000-8000-000000000001','2026-09-02','CREATOR_REVENUE',1482,63,18,228,'DEMO_SEED','MEASURED') on conflict do nothing;
...
('00000000-0000-4000-8000-000000000001','create_internal_task',1,'Create a low-risk internal task',1,'task.create',false) on conflict do nothing;
